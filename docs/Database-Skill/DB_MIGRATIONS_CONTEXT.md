...
-------|--------|----------------------------------------------
 ...
 021   | 021*   | 021_update_service_slot_jsonb.sql  ← update_service_slot riscritta con SINGOLO param jsonb (firma univoca, immune a PGRST202); DROP firma a 9 param (2026-05-15)
  ...
  023   | 023 TEST | 023_service_slots_max_turns_resume.sql  ← colonna max_turns_resume + update_service_slot(jsonb) estesa. Applicare su TEST; NON su produzione finché non richiesto (2026-05-16)
```
