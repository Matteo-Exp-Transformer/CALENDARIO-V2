...
- **`WP-1` (M):** _IN PILOTA — ombra (D27 25-08-26; cutover vietato; istanza 1 blindatura Servizio fatta; istanza 2 checklist QA fatta; collaudo umano 25/26, aperta T7-bis; T9 [O])_
...
| `SEP-SES-20260826-040` | 26-08-2026 | Meta senior · `SEP-AGC-openai-codex-001` | consolidamento prospettico «Agente Matteo» | cartolina e protocolli AM-01/02/03 formalizzati; `SEP-5` = `IN_CORSO`; nessuna istanza, comparabilità, efficacia o autonomia dichiarata | self-report; validator report e revisione fredda restano fonti separate | `non_comparabile` | `Report-piano-operativo-agente-matteo-26-08-26.md` |
| `SEP-SES-20260827-041` | 27-08-2026 | Meta senior · Codex | disegno `AM-C0`: calibrazione read-only di allineamento | protocollo, confini privacy, cinque schede candidate e mandato senior Claude pronti; nessun test eseguito | controlli documentali della seduta; fonti private e chiave non ancora congelate | `non_comparabile` | `Report-preparazione-calibrazione-allineamento-mss-27-08-26.md` |
