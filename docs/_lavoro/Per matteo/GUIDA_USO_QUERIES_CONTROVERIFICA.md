...
### Solo impostazioni menu, promo e vetrina Prenota
...
> **Obsoleto (non usare):** `booking_vol_au_vent_promo_*` — sostituito da `booking_menu_promos` e editor in Personalizza form.
