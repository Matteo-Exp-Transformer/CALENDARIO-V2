...
| Hero foto, swipe carosello, temi; footer data/ora rimosso | E2E seedato in `public-menu-qr.spec.ts`; resta manuale solo il gesto swipe/asset reali quando tocchi la UI |
...
- **E2E pubblica** copre flusso cliente base + visual checklist seedata per carousel, tema, ordine
  categorie, assenza footer, pill in pagina categoria e icona default sulle card senza foto. Restano da guardare a mano solo gesture
