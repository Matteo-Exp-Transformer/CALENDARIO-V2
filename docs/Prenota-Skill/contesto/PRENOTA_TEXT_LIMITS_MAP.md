...
| Badge prenotazione admin | `booking_modes[].booking_badge_label` | 12 | admin-contatore | Non pubblico; fallback a titolo card |
...
| Badge prenotazione admin | `sub_tabs[].booking_badge_label` | 12 | admin-contatore | Non pubblico; fallback a titolo card scorrevole; non mostrato per carosello |
