...
- **A fine** chat, nel report, una sezione **«Lezione della chat — parole e concetti elaborati»**: una
  ...
  **standard reali del lavoro**. 5 punti: (1) che lezione ho ricevuto; (2) cosa ho deciso io
  spontaneamente; (3) **ho deciso bene o sbagliato?** (onesto, non compiacente — nomina gli
  anti-pattern col loro nome: *scope creep*, *premature optimization*…); (4) cosa sento di aver
  appreso; (5) cosa devo ancora consolidare (input per i richiami **spaced-repetition** della sessione
  dopo). Niente voti numerici finché non c'è storico.
