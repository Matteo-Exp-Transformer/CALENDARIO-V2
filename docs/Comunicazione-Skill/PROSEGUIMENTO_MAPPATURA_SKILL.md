...
| **Admin shell + pagine** | 🔶 | **Area 1 Shell:** intervista chiusa + fix flash + `AdminAuthProvider`; resta E2E reale per ✅ PROD (FU-042). **Area 2 Prenotazioni: batch fix Fase D 07-06-26** — D1 race, R1 responsive, D4/D5/D2 chiusi; 29 test `@admin-blindatura: prenotazioni`, `npm run validate` verde **461 test**. Bloccanti ALTO chiusi + QA modale 375/834/1280 OK. Restano FU-046 (D3/U2/U6/E2E). **Non ✅ PROD** finché FU-046 + E2E staging. |
