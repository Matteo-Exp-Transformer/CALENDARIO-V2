...
| **BookingCalendar — layout tab Calendario, altezza celle mese, titolo/data (Oggi), media query titolo** | `docs/ADMIN_CLASSIC_SKILL.md` §4 + `UI_RESPONSIVE_CONTEXT.md` + `UI_THEME_CONTEXT.md` |
