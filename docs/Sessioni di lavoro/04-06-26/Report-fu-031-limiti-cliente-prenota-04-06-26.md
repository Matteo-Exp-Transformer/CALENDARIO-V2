...
✅ R6: Contesto **giusto** per Verifica (TESTING §7 + PRENOTA §3 + mappa §H bastano; esclusione Personalizza/Menu QR rispettata). Hook FINE-SESSIONE **utile**: §11 + controllo **8 report**; incrocio FU-032/courses_label su `PRENOTA_TEXT_LIMITS_MAP` (§H vs §A/§C) — scope separati, Q1–Q6 coerenti tra i report Prenota/meta/hook.
