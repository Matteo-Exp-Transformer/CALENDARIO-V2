    ...
    <div className="min-h-0 flex-1 bg-[var(--color-bg)] px-4 py-6 md:px-6">
      <div className="mx-auto max-w-6xl space-y-6">
        ...
        <div className="space-y-3">
          ...
          {isLoading ? (
            <div
              className="flex h-80 items-center justify-center rounded-xl border border-[var(--color-border)] bg-[var(--color-surface)]"
              role="status"
              aria-live="polite"
            >
            ...
            <p className="rounded-xl border border-[var(--color-border)] bg-[var(--color-surface)] px-4 py-12 text-center text-sm text-[var(--color-text-muted)] shadow-sm">
              Nessuna prenotazione nel periodo selezionato. Scegli un altro intervallo o attendi nuove richieste.
            </p>
          )}
        </div>
      </div>
