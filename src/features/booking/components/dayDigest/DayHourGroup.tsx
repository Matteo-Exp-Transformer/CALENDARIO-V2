  ...
  return (
    ...
    >
      <div className="flex flex-col gap-3 md:flex-row md:gap-3">
        <div className="shrink-0 md:w-16 md:pt-1">
          <span className="inline-flex rounded-md bg-primary-50 px-2.5 py-1 text-[0.9375rem] font-bold leading-none tabular-nums text-primary-900 sm:text-[1rem]">
            {hourLabel}
          </span>
        </div>
